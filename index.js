...
const showInvite = (userData) => {
  app.innerHTML = `
    <main>
      ...
      <p>Convide mais pessoas e concorra a prêmios! Compartilhe o link e acompanhe as inscrições:</p>

      <div class="input-group">
        <label for="link">
          <img src="link.svg" alt="Link icon">
        </label>
        <input type="text" id="link" value="https://evento.com/?ref=${userData.refBy}" disabled/>
      </div>
    </main>
...
const saveUser = (userData) => {
  const newUser = {
    ...userData,
    ref: Math.round(Math.random() * 5000),
    refBy: 100
  }
  users.push(newUser)
  console.log(users)
...
const updateImageLinks = () => {
  document.querySelectorAll("img").forEach(img => {
    if (img.src.includes("githubusercontent")) return
  ...
  const content = `
    <main>
      <section class="about">
        ...
        <p>Um evento feito por e para pessoas desenvolvedoras apaixonadas por criar soluções inovadoras e compartilhar
          conhecimento. Vamos mergulhar nas tendências mais recentes em desenvolvimento de software, arquitetura de
          sistemas e tecnologias emergentes, com palestras, workshops e hackathons.<br/><br/>
